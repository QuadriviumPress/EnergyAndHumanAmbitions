...
::::{admonition} Definition 10.2.1 — Alternative Energy
:class: important
:label: def-10-2-1

is a non-fossil source of energy. Solar, wind, and nuclear would be examples.

::::

::::{admonition} Definition 10.2.2 — Renewable Energy
:class: important
:label: def-10-2-2
...
Nothing, of course, lasts forever, but the sun will continue to operate in its current mode for billions of years more, and this is long enough to count as indefinite, for our purposes. [Table 10.1](#tab-10-1) classifies various sources as to whether they are alternatives or renewables, along with justifications. The items with asterisks are *technically* not renewable, but last long enough that we can treat them as such in a practical sense (see [Box 10.1](#box-10-1)).

:::{table} Energy classification. Asterisks indicate non-replenished, but long-lasting sources.
:label: tab-10-1
:enumerator: 10.1
...
::::{admonition} Box 10.1: About Those Asterisks...
:class: tip
:label: box-10-1

The items sporting asterisks in [Table 10.1](#tab-10-1) deserve additional explanation as to why they are not technically renewable, even if the depletion timescales are extremely long.
...
deposit of heat left over from the collapse/formation of the earth,[^9] the other half coming from radioactive decays of elements ultimately tracing to ancient astrophysical cataclysms.[^10] For both the formation and radioactive contributions, the supply is not replenished after its use, although the timescale for the radioactive decays to fade away is billions of years.

Nuclear fusion needs deuterium and tritium.[^11] Roughly one out of every 10,000 hydrogen atoms is deuterium, so ocean water (H$_{2}$O) will have enough deuterium to last billions of years. Tritium, however, is not found naturally and must be synthesized from lithium, in finite supply. Details will follow in [Chapter 15](#ch-15).
...
Notice that all of the unqualified[^12] “Yes” entries in [Table 10.1](#tab-10-1) originate from the sun. For that matter, fossil fuels represent captured ancient solar energy, stored for all these years. The sun sends energy toward the earth at a rate of 1,360 $\mathrm{W/m}^{2}$. Multiplying this by the projected area[^13] of the earth $(\pi R^{2}_{\oplus}\approx 1.28 \times 10^{14}\mathrm{m}^{2})$ results in 174,000 TW of solar power intercepting the earth. This number *absolutely dwarfs* the 18 TW societal energy budget of all humans on Earth. [Figure 10.1](#fig-10-1) shows graphically what happens to this energy input.
...
First, sunlight arriving at the top of Earth’s atmosphere delivers energy at a rate of 1,360 Joules per second per square meter (1,360 $\mathrm{W/m}^{2})$, which is known as the solar constant [[4](#ref-4)].

Treating Earth as a sphere of radius $R$, it has surface area $4\pi R^{2}$, but the sun doesn’t “see” the whole surface at once. In fact, from the vantage point of the rays of sunlight intercepting Earth, what matters is the *projection* of Earth,[^14] which just looks like a disk of area $\pi R^{2}$. Averaging the solar input across the entire planet therefore reduces the 1,360 $\mathrm{W/m}^{2}$ by a factor of 4 to 340 $\mathrm{W/m}^{2}$.

Not all the sunlight arriving at the top of the atmosphere makes it to the surface, so in practice, a typical location will receive an average[^15] of about 200 $\mathrm{W/m}^{2}$. This is a number that comes up often as a typical insolation, so is worth remembering.

::::

:::{margin}
[[4](#ref-4)]: Kopp et al. (2011), “A new, lower value of total solar irradiance: Evidence and climate significance”
...
| surface absorption | 83,000 | 47.9 | $\odot$ | heats surface; evaporates H$_{2}$O, powers life, wind, etc. |
...
::::{admonition} Box 10.2: Making New Fossil Fuels
:class: tip
:label: box-10-2

We know from [Chapter 8](#ch-8) that fossil fuels get their energy from ancient photosynthesis trapped in buried plant matter.[^20] We also now have a figure for how much solar power goes into photosynthesis: 100 TW.

We can compare this to the power that goes into making *new* fossil fuels right now by noting that the entire fossil fuel resource contains roughly[^21] $10^{23}\mathrm{J}$ (page 132), and formed over something like 100 million years, or about 3 $\times 10^{15}$ seconds. Dividing the two gives a power of about 3 $\times 10^{7}$ W, or 30 MW.[^22]
...
[Table 7.1](#tab-7-1) (p. 111) already gave an account of the mix of energy use in the U.S., including many of the renewables. This section revisits those numbers, in slightly more detail.

:::{table} U.S. Renewable energy consumption in 2018. The last column compares to the 101.3 qBtu total U.S. consumption in 2018 [[34](#ref-34)]. Asterisks denote thermal equivalent conversions. While the second column of numbers would be more naturally expressed in GW, the choice of TW is deliberate to emphasize how small renewable usage is compared to the available resource.
:label: tab-10-3
:enumerator: 10.3
...
In 2018, roughly 11% of energy in the U.S. came from renewable resources. [Table 10.3](#tab-10-3) lists the contributions from each, the data coming from the Annual Energy Review published by the U.S. Energy Information Administration for 2018. As introduced in [Box 7.2](#box-7-2) (p. 111), the EIA adopts the practice of assigning a thermal equivalent for each source, in qBtu, even if the source had nothing to do with a thermal process. The rationale is to put everything on the same footing as fossil fuels, for more direct quantitative comparisons. In doing so, they implicitly use the average thermal-to-delivered energy efficiency for fossil fuels of 37.5%.[^25] In other words, it takes 100 units of thermal fossil energy to produce 37.5 units of useful work. If, then, a solar panel delivers 37.5 units of energy over some amount of time, it will be *called* 100 units of “input” (thermal equivalent), even though it only delivered 37.5 units.[^26]

:::{figure} ../images/fig-10-2.svg
:label: fig-10-2
:enumerator: 10.2
:alt: Same info as Table 10.3 in pie chart form.

Same info as [Table 10.3](#tab-10-3) in pie chart form.
:::

Four forms dominate [Table 10.3](#tab-10-3) (and [Figure 10.2](#fig-10-2)), each roughly equal in contribution. Lumping wood and biofuels into a generic “biomass” puts this aggregate category in the clear lead, accounting for nearly half of our renewable energy.[^27] As noted, the entries in [Table 10.3](#tab-10-3) are in qBtu of thermal equivalent, and these have been converted to TW, for easy comparison to [Table 10.2](#tab-10-2).[^28] A key take-away is how *tiny* the renewable energy numbers are compared to the natural flows in Earth’s energy budget.
...
After this, we will be in a position to assess the entire landscape of alternative energy options ([Chapter 17](#ch-17)). The book will then take a turn away from physics and address how all this new information might fit into future plans at societal and personal levels.

(sec-10-6)=
## 10.6 Problems

1. Based on what you already know or suspect about the alternative energy sources listed in [Section 10.1](#sec-10-1), which ones do you suspect[^30] are pollution free (no emissions, no waste)?

2. Based on what you already know or suspect about the alternative energy sources listed in [Section 10.1](#sec-10-1), which ones do you suspect[^31] have *no* negative environmental impacts? Explain your reasoning.

3. Which of the truly renewable (“Yes” without asterisk) entries in [Table 10.1](#tab-10-1) are limited (finite) in terms of the scale[^32] we could achieve on Earth (explain the nature of the limit), and which are not limited (and why)?

4. Which four entries in [Table 10.1](#tab-10-1) do not ultimately trace entirely to solar energy input to Earth?
...
6. About 30% of the 1,360 $\mathrm{W/m}^{2}$ solar power arriving at Earth is immediately bounced back without a trace. Of the part that remains, when distributed/averaged around the whole sphere,[^34] what is the average energy deposition rate per square meter into the earth system?

7. Based on the numbers in [Table 10.2](#tab-10-2), [Figure 10.1](#fig-10-1), and in the text, what fraction (in percent) of all biological activity on Earth do (all) humans represent, from a metabolic energy standpoint?

8. Based on the numbers in [Table 10.2](#tab-10-2), [Figure 10.1](#fig-10-1), and in the text, what fraction (in percent) is human societal energy production (all activities; fossil fuels, etc.) compared to all biological activity on the planet?

9. What fraction (in percent) of the solar energy *that is absorbed by Earth’s surface* goes into evaporation (the hydrological cycle; refer to [Table 10.2](#tab-10-2), and [Figure 10.1](#fig-10-1))?

10. If we add up the five smallest pieces in [Table 10.2](#tab-10-2), what fraction (in percent) does this set of energy flows represent in comparison to the total solar energy *absorbed by the earth system*?

11. The percentages of absorption and reflection in [Figure 10.1](#fig-10-1) represent averages over weather conditions. On a clear day with the sun overhead, a solar panel has access to more light than the 48% depicted reaching the ground. If we can also capture the portion that on average is reflected by the ground and clouds,[^35] what might we expect for the rate of energy reaching the ground (in $\mathrm{W/m}^{2})$ if the input at the top of the atmosphere is 1,360 $\mathrm{W/m}^{2}$?

12. Similar to [Example 10.3.2](#ex-10-3-2), how much warmer would you expect a 10 cm deep puddle of water[^36] to get after an hour in full sun, if the water absorbs all the energy and does not lose it to the environment?

13. Comparing [Table 10.2](#tab-10-2) and [Table 10.3](#tab-10-3), what is the most striking mismatch,[^37] in terms of large potential vs. small contribution to U.S. energy consumption?
...
15. The U.S. occupies about 2% of Earth’s surface area, thus collecting only part of the 83,000 TW absorbed at the surface. Compare the amount of solar power received by the U.S. to the *total* renewable power in [Table 10.3](#tab-10-3).[^39] By what factor are we “underutilizing” the solar input, under the simplifying assumption that we could use all of it?

[^1]: A turbine is basically a set of fan blades.
[^2]: Wind turbines are sometimes called rotors or windmills.
[^3]: While 38.3 qBtu of the 101.3 qBtu total energy input in the U.S. is dedicated to electricity production, only 13.0 qBtu emerges from the process, which is 17% of the 76 qBtu total flowing into these end-use sectors.
...
[^8]: It would take hundreds of millions of years to “accomplish” this (see [Sec. D.4](#sec-d-4); p. 415).
...
[^12]: … i.e., no asterisk
[^13]: See [Example 10.3.1](#ex-10-3-1).
[^14]: Imagine taking a picture of a sphere situated across the room. The area the sphere takes up on the photo is $\pi R^{2}$, not the total curved surface area of $4\pi R^{2}$. See also [Fig. 9.6](#fig-9-6) (p. 149).
[^15]: … averaging over day, night, sun angles, and weather conditions.
[^16]: That is, heating (see [Example 10.3.2](#ex-10-3-2)); note that solar panels could intercept part of this energy flow.
[^17]: Recall Ex. 5.5.2 (p. 79). 100 W per person times 8 billion people is 800 GW, or 0.8 TW.
[^18]: … parameters defined below
[^19]: Because a Watt is a Joule per second and the table area is 1 $\mathrm{m}^{2}$; the black property essentially means that it absorbs all light that hits it.
...
[^28]: ⚠ The items with asterisks in [Table 10.3](#tab-10-3) will not match production numbers in later chapters for non-thermal resources that are not expressed in thermal-equivalent terms.
...
[^34]: ⚠ account for projected vs. total surface area
[^35]: Recall, it’s a clear day; no clouds.
[^36]: ⓘ Water has a density of 1,000 kg per cubic meter and a specific heat capacity of 4,184 $\mathrm{J/kg}/^{\circ}\mathrm{C}$. Make up whatever area you want; the answer should be the same for any pick.
...
[^38]: ⓘ Use the 37.5% factor discussed in
