...
20. A smidge higher than boiling
...
2. 4%: $\sim$\$1 trillion; 5%: more than \$100 trillion
...
5. [Table 3.2](#tab-3-2) offers a rough check

6. Over 16 billion; less than half the time we now experience

7. Pretty close to [Table 3.2](#tab-3-2) except for first two entries

8. Answer *must* be less than 14 billion; whereas Problem 6 was in excess of 15 billion
...
7. Two of the points in [Example 5.2.1](#ex-5-2-1) offer guidance

8. [Figure 5.1](#fig-5-1) offers hints
...
14. Results should be roughly consistent with [Figure 5.2](#fig-5-2)
...
21. Comparable to running a clothes dryer ([Fig. 5.2](#fig-5-2))
...
36. Between 3–$5\times 10^{-19}$ J per photon; get more than $10^{18}/$sec

37. In the neighborhood of 1 $\mu \mathrm{m}$ or 1 eV
...
17. $\Delta T > 50^{\circ}\mathrm{C}$; environment not that cold
...
9. Between 1–2 ppm$_{\mathrm{v}}$, in agreement with [Figure 9.3](#fig-9-3)
...
13. About $10^{\circ}\mathrm{C}$ cooler than actual
...
18. Triple pre-industrial and almost $5^{\circ}\mathrm{C}$

19. End $\sim 3^{\circ}\mathrm{C}$ high; almost linear, but not quite
...
4. [Table 10.2](#tab-10-2) has some help

5. Can’t rely on any sun-driven energy

6. Between 200–250 $\mathrm{W/m}^{2}$
...
11. Not far from 1,000 $\mathrm{W/m}^{2}$
...
4. Mass shows up in both $mgh$ and $\frac{1}{2}mv^{2}$
...
6. Use [Eq. 13.3](#eq-13-3) to guide your reasoning

7. Should match [Figure 13.1](#fig-13-1)

8. One micron for each finger?

9. Think about spill-over into UV and/or IR

10. Peak around $2.5 \times 10^{8}$, about 1 $\mu \mathrm{m}$ wide; matches up well
...
20. Get very close to 1,360 $\mathrm{W/m}^{2}$

21. Sweltering is not preferred

22. Between 5–6 $\mathrm{kWh/m}^{2}/$day; between 200–250 $\mathrm{W/m}^{2}$

23. Involves interpreting $\mathrm{kWh/m}^{2}/$day as full-sun-hours

24. Not far from 200 $\mathrm{W/m}^{2}$

25. Range straddles 200 $\mathrm{W/m}^{2}$, varying about 10%

26. Best at latitude; almost 15% better than flat

27. Approaches 6 $\mathrm{kWh/m}^{2}/$day
...
35. Even lower than $\sim 20\%$ from insolation vs. overhead

36. About \$2-worth of sun

37. Hint: study [Figures 13.23](#fig-13-23) and 13.24

38. In absolute terms…

## Chapter 14

1. About a dozen tons of CO$_{2}$
...
7. Roughly consistent with [Table 14.1](#tab-14-1) for coal
...
19. Energy has a mass, via $E = mc^{2}$
...
26. Stick to 80 $< A < 110$ and 125 $< A < 155$ to respect distributions
...
12. A little more than 6 times that in [Example 16.4.1](#ex-16-4-1)
